...
.product {
    ...
    justify-content: space-between; /* Đảm bảo nội dung được căn đều từ trên xuống */
    height: 100%; /* Đảm bảo tất cả thẻ có chiều cao bằng nhau */
    border: 1px solid #ddd; /* Đường viền cho mỗi thẻ */
    padding: 15px;
    box-sizing: border-box; /* Tính padding trong chiều cao và chiều rộng */
    border-radius: 5px;
    background-color: #fff;
}

.product img {
    max-width: 100%; /* Đảm bảo hình ảnh không vượt quá kích thước thẻ */
    height: auto;
    margin-bottom: 15px;
}
